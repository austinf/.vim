...
syn keyword basicStatement	CONST const Const PROCEDURE procedure Procedure
...
syn keyword basicStatement	EVENT event Event
...
syn keyword basicFunction	UBOUND ubound Ubound
